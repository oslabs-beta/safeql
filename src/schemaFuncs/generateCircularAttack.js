...
export const circularAttack = (
  ...
  let attackQuery = `query { ${constructingQuery.repeat(complexity)} ${
    finalSubFieldOptions[0]
  } ${'}'.repeat(closingParens)}`;
