...
//chalky = numbers
const  violet = "#800033", white = "#dce4ef", sage = "#c9dfb9", whiskey = "#dbb18a",
cyan = "#143438", invalid = "#ffffff", chalky = "#e9cc95",ivory = "#2c313a", stone = "#2d3139", // Brightened compared to original to increase contrast
malibu = "#0e538b",   darkBackground = "#21252b", highlightBackground = "#2c313a", background = "#282c34", tooltipBackground = "#353a42", selection = "#38537a", cursor = "#528bff";
